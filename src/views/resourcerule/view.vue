  ...
  <el-form label-width="120px">
    ...
    <el-col :span="6">
      <el-form-item label="灰度资源">
        <el-input placeholder="必须与应用内注解配置一致"  v-model="resourceName" :disabled="true"></el-input>
      </el-form-item>
    </el-col>
    <el-col :span="12">
        ...
        <el-col :span="24">
          <el-form-item label="host规则:">
            ...
            <el-col :span="3" v-for="(item,i) in onlineHosts">
                <el-button @click="selecthost(item)" v-bind:type="item.type" class="component-sel" :disabled="true">{{item.text}}</el-button>
            </el-col>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="24">
          <el-form-item label="频率规则:">
            ...
            <el-col :span="8" style="margin-top:10px;">
              <el-input v-model="frequenceRule.initLimit" placeholder="初始允许的请求个数 X" style="width:60%" :disabled="true"></el-input>
            </el-col>
            <el-col :span="8" style="margin-top:10px;">
              <el-input v-model="frequenceRule.timeWindowSec" placeholder="窗口期,单位为秒 Y" style="width:60%" :disabled="true"></el-input>
            </el-col>
            <el-col :span="8" style="margin-top:10px;">
              <el-input v-model="frequenceRule.limitStep" placeholder="重置请求个数或递增步长 Z" style="width:60%" :disabled="true"></el-input>
            </el-col>
